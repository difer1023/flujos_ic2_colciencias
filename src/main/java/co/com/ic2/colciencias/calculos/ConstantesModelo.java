...
public class ConstantesModelo {
    ...
    //No est� en tabla de subtipo de alta calidad
    ...
    //Indicadores de producci�n por tipo de producto
    ...
    //C�lculo indicadores de cohesi�n y colaboraci�n
    ...
    //C�lculo de �ndices de producci�n de clase
