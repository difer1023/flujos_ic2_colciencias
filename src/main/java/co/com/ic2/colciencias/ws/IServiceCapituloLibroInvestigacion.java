...
public interface IServiceCapituloLibroInvestigacion {
	...
	public String consultarClasificacionCapitulosLibrosInvestigacion(int codigoGrupo);
	
	public List<CapituloLibroPublicado> consultarCapitulosLibrosInvestigacion();
	
	public List<CapituloLibroPublicado> consultarCapitulosLibrosInvestigacionGrupo(int codigoGrupo);

	public String insertarCapituloLibroInvestigacion(@WebParam(name = "codigo") String codigo,
			@WebParam(name = "isbnLibro") String isbnLibro, @WebParam(name = "tituloCapitulo") String tituloCapitulo,
	...
	public String insertarCapitulosLibroInvestigacion(@WebParam(name = "codigoGrupo") String codigoGrupo,
			@WebParam(name = "capitulosLibro") ArrayList<CapituloLibroPublicado> capitulosLibro);
}