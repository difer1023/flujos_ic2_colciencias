...
public interface IServiceDocumentoTrabajo {
	...
	public String insertarDocumentosTrabajo(@WebParam(name="codigoGrupo") String codigoGrupo,@WebParam(name="documentosTrabajo") ArrayList<DocumentoTrabajo> documentosTrabajo);
}